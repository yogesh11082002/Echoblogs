...
//         setTitle(""); setSubTitle(""); setContent(""); setCategory("Select Category"); setIsPublished(false); setImage(null);
//         if (onBlogAdded) onBlogAdded(); // refresh parent
...
//       <input type="text" placeholder="Blog Title" value={title} onChange={(e) => setTitle(e.target.value)} className="w-full p-2 border rounded" required />
//       <input type="text" placeholder="Sub Title" value={subTitle} onChange={(e) => setSubTitle(e.target.value)} className="w-full p-2 border rounded" />

//       <div className="relative">
//         <ReactQuill value={content} onChange={setContent} theme="snow" className="h-60" />
//         <button type="button" onClick={generateContentHandler} disabled={isGenerating} className="absolute bottom-2 right-2 px-4 py-1 bg-black text-white rounded text-xs">
//           {isGenerating ? "Generating..." : "Generate AI"}
//         </button>
//       </div>

//       <select value={category} onChange={(e) => setCategory(e.target.value)} className="px-3 py-2 border rounded w-48">
//         <option value="">Select Category</option>
//         <option value="Technology">Technology</option>
//         <option value="Startup">Startup</option>
//         <option value="Lifestyle">Lifestyle</option>
...
//       <motion.button type="submit" disabled={isAdding || isGenerating} whileHover={{ scale: 1.05 }} className="w-40 h-10 bg-primary text-white rounded">
